...
public class StudentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            out.println(".student-table td {");
            out.println("padding: 14px 25px;");
            out.println("border-bottom: 1px solid #e2e8f0;");
            out.println("text-align: left;");
            out.println("}");

            out.println(".student-table th:nth-child(1),");
            out.println(".student-table td:nth-child(1) {");
            out.println("width: 30%;");
            out.println("}");

            out.println(".student-table th:nth-child(2),");
            out.println(".student-table td:nth-child(2) {");
            out.println("width: 35%;");
            out.println("}");

            out.println(".student-table th:nth-child(3),");
            out.println(".student-table td:nth-child(3) {");
            out.println("width: 35%;");
            out.println("}");

            out.println(".student-table tr:hover td {");
